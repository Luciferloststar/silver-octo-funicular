...
import { FacebookIcon, InstagramIcon, RedditIcon, XIcon, WhatsAppIcon, BookmarkIcon } from './Icons';
...
const ContentSection: React.FC<ContentSectionProps> = ({ id, title, items }) => {
